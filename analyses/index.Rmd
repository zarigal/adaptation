...
plots1 <-plot_grid(P1, P2, align = "v", nrow = 2, ncol = 1, rel_heights = c(1/2,1/2))
plots2 <- plot_grid(P3, P4, align = "v", nrow = 2, ncol = 1, rel_heights = c(1/2,1/2))
plots3 <- plot_grid(P5, align = "v", nrow = 1, ncol = 1, rel_heights = 1)
plots <- plots1 + plots2 + plots3
plots + plot_annotation(title = "Growth in Height (cm) by Year", theme = theme(plot.title = element_text(hjust = 0.5)))
```
...
plots3 <- plot_grid(P5, align = "v", nrow = 1, ncol = 1, rel_heights = 1)
plots <- plots1 + plots2 + plots3
plots + plot_annotation(title = "Growth in Diameter (mm) by Year", theme = theme(plot.title = element_text(hjust = 0.5)))
```
```{r}
