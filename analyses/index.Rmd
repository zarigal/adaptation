...
Trees from Oregon had a mean total height increase of `r round(treesno.summary$mean.total.height.growth[treesno.summary$Seed.Zone=="OR"],2)`cm and trees from Washington had a mean total height increase of `r round(treesno.summary$mean.total.height.growth[treesno.summary$Seed.Zone=="WA"],2)`cm.
