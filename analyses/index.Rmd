...
trees.no.browse <- read.csv("https://raw.githubusercontent.com/zarigal/adaptation/refs/heads/main/data/adaptation-data-merged.csv")
#if offline - data <-read.csv("data/adaptation-data-merged.csv")
```
...
```{r message=FALSE}
treesno.summary <- treesno.wide.pos.all %>% group_by(Seed.Zone)  %>% summarize(
n=n(),
