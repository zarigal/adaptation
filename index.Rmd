...
* As a repository collaborator:
  + You are welcome to clone the repository to your system and work from the R Project (adaptation.Rproj) file in Rstudio or you can make changes to the .csv file (./data/WRC Tree Measurements 3.28.22.csv).
